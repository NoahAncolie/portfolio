        ...
        <div className="histoire-art-cours">
            ...
            <div className="cours-content">
                ...
                <div id="architecture" className="partie-cours">
                    ...
                    <Limiter/>
                    <ol>
                        <li>Retour aux <span className="tooltip" onMouseOver={() => {setFocus(<><p><i>L'ordre</i>, en architecture, détermine les <b>proportions</b>, les <b>formes</b> et l'<b>ornementation</b> de toute partie construite en élévation.</p></>)}}>ordres</span> antiques Grecquo-Romains</li>
                        <li>L'ornementation de l'édifice est un point plus important que l'ossature. 
                            Sont utilisés : 
                            <ul>
                                <li><span className="tooltip" onMouseOver={() => {setFocus(<><FocusImg src={voute} alt="Voûte Renaissance Italienne" /><i>Les Pouilles, Italie</i> <br/>: <p>Une voûte est un ouvrage architectural,dont le dessous est fait en arc ou en plate-bande</p></>)}}>Voûtes</span></li>
                                <li><span className="tooltip"  onMouseOver={() => {setFocus(<><FocusImg src={arcade} alt="Ardades de la cathédrale de Pise" /><i>Pise, Italie</i> <br/>: <p>Une arcade est une série ordonnée d'arcs.</p></>)}}>Arcades</span></li>
                ...
                <div id="decorations" className="partie-cours">
                    ...
                    <p>
                        ...
                        <ul>
                            ...
                            <li>Les <span className="tooltip"  onMouseOver={() => {setFocus(<><FocusImg src={grotesque} alt="Grotesque sur une colonne" /><h2>Grotesque</h2> <p>Nom donné aux ornements fantastiques découverts aux XVᵉ et XVIᵉ siècle dans les ruines des monuments antiques Italiens.</p></>)}}>Grotesques</span></li>
                            <li>Les Enfants</li>
