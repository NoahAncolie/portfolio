                ...
                <div id="architecture" className="partie-cours">
                    ...
                    <ol>
                        ...
                        <li>L'ornementation de l'édifice est un point plus important que l'ossature. 
                            Sont utilisés : 
                            <ul>
                                <li><span className="tooltip" onMouseOver={() => {setFocus(<><img className="tooltip-img" src={voute} alt="Voûte Renaissance Italienne" /><i>Les Pouilles, Italie</i> <br/>: Une voûte est un ouvrage architectural,dont le dessous est fait en arc ou en plate-bande</>)}}>Voûtes</span></li>
                                <li><span className="tooltip"  onMouseOver={() => {setFocus(<><img className="tooltip-img" src={arcade} alt="Ardades de la cathédrale de Pise" /><i>Pise, Italie</i> <br/>: Une arcade est une série ordonnée d'arcs.</>)}}>Arcades</span></li>
